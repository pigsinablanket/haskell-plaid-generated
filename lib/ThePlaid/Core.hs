...
-- | display the config
instance P.Show ThePlaidConfig where
  show c =
    T.printf
...
-- | constructs a default ThePlaidConfig
--
-- configHost:
--
...
-- @"the-plaid/0.1.0.0"@
--
newConfig :: IO ThePlaidConfig
newConfig = do
    logCxt <- initLogContext
    return $ ThePlaidConfig
        { configHost = "https://production.plaid.com"
        , configUserAgent = "the-plaid/0.1.0.0"
...
addAuthMethod config@ThePlaidConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ThePlaidConfig -> IO ThePlaidConfig
...
withStderrLogging :: ThePlaidConfig -> IO ThePlaidConfig
...
data ThePlaidRequest req contentType res accept = ThePlaidRequest
  { rMethod  :: NH.Method   -- ^ Method of ThePlaidRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ThePlaidRequest
  , rParams   :: Params -- ^ params of ThePlaidRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ThePlaidRequest req contentType res accept) NH.Method
rMethodL f ThePlaidRequest{..} = (\rMethod -> ThePlaidRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ThePlaidRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ThePlaidRequest{..} = (\rUrlPath -> ThePlaidRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ThePlaidRequest req contentType res accept) Params
rParamsL f ThePlaidRequest{..} = (\rParams -> ThePlaidRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ThePlaidRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ThePlaidRequest{..} = (\rAuthTypes -> ThePlaidRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ThePlaidRequest req contentType res accept -> param -> ThePlaidRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ThePlaidRequest req contentType res accept -> param -> ThePlaidRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ThePlaidRequest req contentType res accept -> param -> ThePlaidRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
setHeader ::
     ThePlaidRequest req contentType res accept
  -> [NH.Header]
  -> ThePlaidRequest req contentType res accept
...
removeHeader :: ThePlaidRequest req contentType res accept -> [NH.HeaderName] -> ThePlaidRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ThePlaidRequest req contentType res accept
    -> IO (ThePlaidRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ThePlaidConfig
  -> IO (ThePlaidRequest req contentType res accept)
_applyAuthMethods req config@(ThePlaidConfig {configAuthMethods = as}) =
  foldlM go req as
  where
