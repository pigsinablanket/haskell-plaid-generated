## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `The Plaid API`
...
./generate-code.sh
```
Change params directly in the .sh file.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | ThePlaid                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | the-plaid                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ThePlaidConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ThePlaidRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ThePlaid.Client    | use the "dispatch" functions to send requests       |
| ThePlaid.Core      | core funcions, config and request types             |
| ThePlaid.API       | construct api requests                              |
| ThePlaid.Model     | describes api models                                |
| ThePlaid.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ThePlaid.ModelLens | lenses for model fields                             |
| ThePlaid.Logging   | logging functions and utils                         |
